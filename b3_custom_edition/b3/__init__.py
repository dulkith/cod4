...
__author__ = 'SLeSPORTS'
__version__ = '3.0'

modulePath = pkg_handler.resource_directory(__name__)

versionId = 'v%s' % __version__
version = '^8COD4-LK ^0(^8b3^0) ^9%s ^9[^3SLeSPORTS [B3] Customized Edition by Duka^9]^3' % versionId

confdir = None
console = None

# STRINGS
B3_TITLE = 'COD4-LK (B3) Customized Edition by Duka %s' % versionId
B3_TITLE_SHORT = 'COD4-B3 %s' % versionId
...
def start(mainconfig, options):
    ...
    sys.stdout.write('Starting COD4-B3      : %s\n' % getB3versionString())
