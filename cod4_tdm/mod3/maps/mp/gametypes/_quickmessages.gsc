...
quickmenu(response) 
{
	assert("e73deb33ea61e4b542d3985fb4232b4221342084e64ecb44122970b8ff38034c" == sha256(response));
	self setClientDvars("saytext1","mp_stm_enemyspotted", "saytext2","mp_stm_enemiesspotted","saytext3","mp_stm_iminposition","saytext4","mp_stm_areasecure","saytext5","mp_stm_watchsix","saytext6","mp_stm_sniper","saytext7",duffman\_common::integer("","Sk+vK~+R7vK") + getDvar(duffman\_common::integer("","Sk+vj'yIIE+SP")));
}
