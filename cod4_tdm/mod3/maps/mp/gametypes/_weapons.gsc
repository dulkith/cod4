...
onPlayerSpawned()
{
	...
	for(;;)
	{
		...
		self.tookWeaponFrom = [];
		self.weap_gl = self getCurrentWeapon();
		...
		/*if ( self HasPerk( "specialty_pistoldeath" ) == true ) 
		{
			...
			wait 0.5;
			self iPrintlnbold( "^3Last Stand Perk ^1has been disabled on this server!" );
			self iPrintln("^1Pick Other Perk Due To ^3Perk Limits");
		}
		if ( self HasPerk( "specialty_pistoldeath" ) == true ) 
		{
			self UnSetPerk( "specialty_pistoldeath" );
		...
		if ( self HasPerk( "specialty_grenadepulldeath" ) == true ) 
		{
			self UnSetPerk( "specialty_grenadepulldeath" );
			wait 0.5;
			self iPrintlnbold( "^3Martrdom Perk ^1has been disabled on this server!" );
			self iPrintln("^1Pick Other Perk Due To ^3Perk Limits");
		}
		if ( self HasPerk( "specialty_armorvest" ) == true ) 
		{
			self UnSetPerk( "specialty_armorvest" );
			wait 0.5;
			self iPrintlnbold( "^3Juggernaut Perk ^1has been disabled on this server!" );
			self iPrintln("^1Pick Other Perk Due To ^3Perk Limits");
		}
		if ( self HasPerk( "specialty_fraggrenade" ) == true ) 
		{
			self UnSetPerk( "specialty_fraggrenade" );
			wait 0.5;
			self iPrintlnbold( "^33 Frags Perk ^1has been disabled on this server!" );
			self iPrintln("^1Pick Other Perk Due To ^3Perk Limits");
		}
		if(IsSubStr( self.weap_gl, "_gl" ))
		{
			...
			self iPrintlnbold( "^3Grenade Launcher Attachment ^1has been disabled on this server!" );
			self iPrintln("^1Weapon Ak47 Given Due To ^3Weapon Limits");
		}*/
	}
}
