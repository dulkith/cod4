...
init() {
	...
	//text[0] = "I must be ^1{G} clan^7 member";
	//text[1] = "^5\"^1{G} clan^7 the best\"";
	text[0] = "^1|^3SL^1e^3SPORT^1| ^4Gaming Community";
	text[1] = "^1|^3SL^1e^3SPORT^1| ^4Gaming Community";
...
Connected() {
	if(!isDefined(self.pers["killstats"])) {
		...
		if(!isDefined(text) || text == "I must be ^1{G} clan^7 member" || text == "") {
