...
startMapvote()
{
	if(getentarray("player", "classname").size < 6 && getDvar("server_type") != "sd")
		setDvar( "sv_maprotation", "gametype war map mp_crash gametype war map mp_crossfire gametype war map mp_shipment gametype war map mp_killhouse gametype war map mp_strike gametype war map mp_backlot gametype war map mp_bloc" );
	else if(getDvar("server_type") != "sd")
		setDvar("sv_mapRotation" , "gametype war map mp_convoy gametype war map mp_backlot gametype war map mp_bloc gametype war map mp_bog gametype war map mp_countdown gametype war map mp_crash gametype war map mp_crossfire gametype war map mp_citystreets gametype war map mp_farm gametype war map mp_broadcast gametype war map mp_carentan gametype war map mp_killhouse gametype war map mp_overgrown gametype war map mp_pipeline gametype war map mp_shipment gametype war map mp_showdown gametype war map mp_strike gametype war map mp_vacant gametype war map mp_cargoship gametype war map mp_crash_snow");
	else 
	...
	hud[3] setText("^3SL^1e^3SPORT ^7TDM ^4Mapvoter System");
