...
startMapvote()
{
	setDvar( "sv_maprotation", "gametype war map mp_backlot gametype war map mp_bog gametype war map mp_cargoship gametype war map mp_citystreets gametype war map mp_convoy gametype war map mp_countdown gametype war map mp_crash gametype war map mp_crossfire gametype war map mp_shipment gametype war map mp_showdown gametype war map mp_strike gametype war map mp_vacant gametype war map mp_broadcast");
	...
	hud[3].font="objective";
	hud[3] setText("^7| ^3Mapvote System ^7|");
