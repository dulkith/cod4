...
/* Absolute Path
 * The absolute path to the script directory, if its on root ( / ), if its inside a directory ( /directory/ )
 */
define('ABS_PATH', dirname(__FILE__) . '/');

/* Root URL
 * Enter the domain name of the web site, if its on root ( http://localhost/ ), if its inside a directory ( http://localhost/directory/ )
 */
define('ABS_URL', 'http://localhost/cod4_status/');

/* identKey
 * Enter the identkey of the screenshot sender plugin, you have to define the identkey inside your server.cfg (seta nehoscreenshot_identkey "my_secret_identkey") enter the same identkey here
 */
define('ID_KEY', '123123123');


/** ######################################## DO NOT CHANGE BELOW NOTHING ##################################################**/
